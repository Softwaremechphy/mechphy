...
cd ~/Desktop/testing/sci-fi-simulator
...
gnome-terminal -- bash -c "cd ~/Desktop/testing/7skeleton-master && source venv/bin/activate && python3 main.py replay; exec bash"
